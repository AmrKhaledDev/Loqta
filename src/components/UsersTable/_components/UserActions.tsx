  ...
  return (
    <TdTable>
      ...
      <button
        ...
        className={`mytransition ${user.emailVerified ?"bg-red-950/80 ring-red-900/50 text-red-300" :"text-green-300 ring-green-300"} text-sm ring  mr-2 py-1 px-3 rounded-lg  hover:scale-103 active:scale-95 hover:shadow-2xl hover:ring-green-900/40 `}
      >
        {user.emailVerified
          ? activationLoading
            ? "جاري الإلغاء . . ."
