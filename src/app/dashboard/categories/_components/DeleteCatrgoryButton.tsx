      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              تنبيه: أنت على وشك حذف هذا الصنف نهائياً. يرجى العلم أن هذا
              الإجراء سيؤدي إلى إزالة الصنف من المتجر، وقد يؤثر على عرض المنتجات
              المرتبطة به. لا يمكن التراجع عن هذه الخطوة بعد إتمامها.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
