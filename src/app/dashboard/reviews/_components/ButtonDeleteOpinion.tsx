...
function ButtonDeleteOpinion({ opinion }: { opinion: OpinionDBType }) {
  ...
  return (
    <button
      ...
      className="not-disabled:active:scale-95 mytransition lg:text-xs text-[10px] not-disabled:hover:scale-102 text-red-500 ring ring-red-500 py-2 rounded-md not-disabled:cursor-pointer disabled:text-gray-400 font-semibold"
    >
